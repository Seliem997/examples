...
import 'package:learning/luna_learning/utilities/widgets/preview.dart';
...
class BuildCoursesCarousel extends StatelessWidget {
  ...
  BuildCoursesCarousel({required this.title, required this.image, required this.imageRoute, required this.color});
  @override
