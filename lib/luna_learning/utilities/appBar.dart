...
import 'package:learning/luna_learning/utilities/widgets/painters/circle_painter.dart';
...
class CustomAppBar extends PreferredSize {
  ...
  CustomAppBar({required this.child, this.height = kToolbarHeight,this.width=100}) : super(child: child,preferredSize: Size(width,height) );
